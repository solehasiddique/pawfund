...
const features = [
  {
    ...
    title: "Direct Impact",
    description:
      "100% of your donation goes directly to helping stray dogs. No hidden fees or overhead costs.",
  },
  {
    icon: Shield,
    title: "Verified Campaigns",
    description:
      "Every campaign is thoroughly vetted by our team to ensure authenticity and transparency.",
  },
  {
    icon: Users,
    title: "Community Driven",
    description:
      "Join thousands of animal lovers making a real difference in the lives of stray dogs.",
  },
  {
    icon: Zap,
    title: "Fast Funding",
    description:
      "Urgent cases get prioritized so dogs in critical need receive help immediately.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Browse through verified campaigns for stray dogs in need of medical care, shelter, or food.",
  },
  {
    icon: Heart,
    title: "Make a Donation",
    description:
      "Choose your contribution amount and donate securely. Every dollar makes a difference.",
  },
  {
    icon: CheckCircle,
    title: "Track the Impact",
    description:
      "Receive updates on how your donation is helping and see the lives you're changing.",
  },
];
...
const featuredCampaigns = [
  {
    ...
    daysLeft: 5,
    description:
      "Bella was hit by a car and needs urgent surgery to walk again.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    daysLeft: 3,
    description:
      "Max needs treatment for severe skin infection and malnutrition.",
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Join our community in funding life-saving care, shelter, and
                love for stray dogs around the world. Every donation makes a
                difference.
              </p>
      ...
      <section className="px-6 py-20 mx-auto max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            We're committed to making every donation count and every stray dog
            matter.
          </p>
        </div>
